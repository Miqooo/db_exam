...
def fillDatabase(companies_count = 10, products_count=30, supplies_count=10):
...
def main():
    ...
    post_parser.add_argument('--endpoint', type=str, help='API endpoint for the POST request')
    ...
    get_parser.add_argument('--endpoint', type=str, help='API endpoint for the GET request')
    get_parser.add_argument('--params', type=json.loads, default={}, help='Query parameters in JSON format')
